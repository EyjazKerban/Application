...
import 'package:flutter_app/features/tutor/resource/screens/createresource.dart';
...
class TutorResourceView extends StatefulWidget {
  const TutorResourceView({Key? key}) : super(key: key);

  @override
  _TutorResourceViewState createState() => _TutorResourceViewState();
}

class _TutorResourceViewState extends State<TutorResourceView> {
