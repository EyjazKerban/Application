...
import 'package:flutter_app/features/tutor/payment/screens/tutorpaymentsview.dart';
...
class TutorMonthlyPaymentsPage extends StatefulWidget {
  const TutorMonthlyPaymentsPage({Key? key}) : super(key: key);

  @override
  _TutorMonthlyPaymentsPageState createState() =>
      _TutorMonthlyPaymentsPageState();
}

class _TutorMonthlyPaymentsPageState extends State<TutorMonthlyPaymentsPage> {
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                                builder: (context) => const TutorPaymentsView()),
                          );
                        },
                        child: Container(
