...
import 'package:flutter_app/features/student/classrooms/screens/joinclassroom.dart';
...
class StudentClassrooms extends StatefulWidget {
  const StudentClassrooms({super.key});
...
class _StudentClassroomsState extends State<StudentClassrooms> {
  ...
  void initState() {
    super.initState();
    _classroomsFuture = ClassroomService.getStudentClassrooms(context);
  }
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const JoinClassroom()),
                      );
                    },
                  ),
                ],
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  if (classrooms.isEmpty) {
                    return const Expanded(
                      child: Center(
                        child: Text(
                          '                    No classrooms found!\nClick on the add button to join a classroom',
                          style: TextStyle(
                            fontSize: 16,
                            color: Colors.black,
                          ),
